...
inline void solveConbi() {
	...
	for (int64 i = 2; i < 17; ++i) {
		conbi[16][i] = conbi[16][i - 1] * (16 - i + 1) / i;
	}

	for (int64 i = 2; i < 13; ++i) {
...
inline void solveNPoker(int64 dep, int64 re_dep, int64 cur) {
	if (dep % 2) {
